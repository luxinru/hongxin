		...
		<div class="footer_nav" v-if="show_footer && footer_type === 'n2'">
			<div class="indexnav">
				<div class="nav_top btn-group" >
					<router-link class="footer_item" to="/tree"><img :src="show_type == 'tree' ? require('./assets/tabs/sy1.png'):require('./assets/tabs/sy0.png')"   /><span>首页</span></router-link>
					<router-link class="footer_item" to="/item"><img :src="show_type == 'touzi' ? require('./assets/tabs/tz1.png'):require('./assets/tabs/tz0.png')"  /><span>投资</span></router-link>
					
					<router-link class="footer_item" to="/index"><img :src="show_type == 'mission' ? require('./assets/tabs/rw1.png'):require('./assets/tabs/rw0.png')" /><span>任务</span></router-link>

					<router-link class="footer_item" to="/user"><img :src="show_type == 'info' ? require('./assets/tabs/wd1.png'):require('./assets/tabs/wd0.png')" /><span>我的</span></router-link>
				</div>
			</div>
		</div>
		<div id="footer" v-if="show_footer && footer_type === 'n1'">
			<div class="indexnav">
				<div class="nav_top btn-group" style="    justify-content: center;">
					<router-link class="footer_item" to="/tree"><img :src="show_type == 'tree' ? require('./assets/tabs/sy1.png'):require('./assets/tabs/sy0.png')"  /><span>首页</span></router-link>
					<router-link class="footer_item" to="/mission"><img :src="show_type == 'mission' ? require('./assets/tabs/rw1.png'):require('./assets/tabs/rw0.png')" /><span>任务</span></router-link>
					<router-link class="footer_item" to="/info"><img :src="show_type == 'info' ? require('./assets/tabs/wd1.png'):require('./assets/tabs/wd0.png')"   /><span>我的</span></router-link>
				</div>
			</div>
		</div>
		<kefu></kefu>
