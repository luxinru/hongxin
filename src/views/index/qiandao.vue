<template>
	...
	<div class="headerminBox"> 
		<div class="cardBox">
			...
			<div class="qd-info">
				...
				<p class="qdtishi">本活动按要求坚持连续打卡签到完成,即可领取以下奖品,请务必填清楚详情收货地址。</p>
	...
	<div class="middleBox">
		<div class="qd-tips">
			<p>您已连续签到</p>
			<p style="margin-top: 10px;font-size: 20px;font-weight: bold;"><span>2</span>天</p>
		</div>
...
.middleBox{
	...
	.right{
		width: 204px;
		height: 42px;
		background: linear-gradient(0deg, #FF5C21 0%, #FF252F 100%);
		border-radius: 21px;
		font-size: 15px;
...
.qiandao-page{
	min-height: 100vh;
	background-image: url('./image/sf/qiandao_bgs.png');
