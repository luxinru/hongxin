        ...
        <div class="recharge-manner-box">
            <div class="recharge-money-input-box">
                ...
                <div class="recharge-money-input">
                    <input type="number" class="money-input" step="0.01" name="money" v-model="money" placeholder=""/>
                </div>
            </div>
                ...
                <div class="recharge-manner-header">
                    <van-radio-group v-model="type">
                        <template  v-for="(channel, key) in data.config">
                            <div class="recharge-manner-header-item" :class="type==channel.key?'recharge-manner-header-item-active':''":key="key" v-if="channel.is_show" @click="type = channel.key">
