<template>
  <div class="page">
    ...
    <div class="code">
      <div class="item">
        <span class="title">Android二维码</span>
        <img src="@/assets/hongxin/安卓二维码.png" alt="" />
      </div>
      <div class="item">
        <span class="title">IOS二维码</span>
        <img src="@/assets/hongxin/苹果.png" alt="" />
      </div>
    </div>

    <div class="tip">邀请好友扫码下载完成后，填写好友用户名（手机号码）即可完成好友邀请！</div>
    <!-- <div class="main-cont">
      <div class="content">
