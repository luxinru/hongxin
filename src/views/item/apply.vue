	...
	<div class="apply-container">
		<div class="zhye">
			<div class="apply-form-item">
			    <div class="apply-form-item-title" style="font-size: 17px;color: #0C1D34;font-weight: bold;">账户余额</div>
			    <div class="apply-form-item-info" style="color: #53B1F2;">{{data.user_money}}</div>
			</div>
			<div class="apply-form-item">
		...
		<div class="apply-form-container">
            <div class="apply-form-box">
                <div class="apply-form-money">
                    ...
                    <div class="apply-form-money-input">
                        <van-field v-model="money" @input="changeInput()" type="text" label-class="transaction-input" placeholder="请输入金额" />
                    </div>
			...
			<div class="apply-form-box">
			    ...
			    <div class="transaction-box">
			        <div class="transaction-title">支付密码</div>
